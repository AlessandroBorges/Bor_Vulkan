 ...
 */
 public class VkAttachmentReference extends VkStruct {
    ...
    */  
	 ...
	 */
	 public static VkArray<VkAttachmentReference> createVkArray(int size){ 
		 VkAttachmentReference[] array = new VkAttachmentReference[size]; 
		 VkArrayStruct<VkAttachmentReference> vkArray = new VkArrayStruct<VkAttachmentReference> (array, TAG_ID);
		 return vkArray; 
	 } 
