 ...
 public class VkSparseImageOpaqueMemoryBindInfo extends VkStruct {
    ...
    */  
	...
	VkSparseMemoryBind[]  	pBinds;
	 private BigBuffer<VkSparseMemoryBind> 	 pBindsBUFFER;
	/**
	 * Ctor
	 */
	 ...
	 */
	 public static VkArray<VkSparseImageOpaqueMemoryBindInfo> createVkArray(int size){ 
		 VkSparseImageOpaqueMemoryBindInfo[] array = new VkSparseImageOpaqueMemoryBindInfo[size]; 
		 VkArrayStruct<VkSparseImageOpaqueMemoryBindInfo> vkArray = new VkArrayStruct<VkSparseImageOpaqueMemoryBindInfo>(array, TAG_ID);
		 return vkArray; 
	 } 
	 ...
	 */ 
	 public VkSparseImageOpaqueMemoryBindInfo pBinds(VkSparseMemoryBind[] pBinds){
		 this.pBinds = pBinds;
		 this.pBindsBUFFER = new BigBuffer<VkSparseMemoryBind>(pBinds, VkSparseMemoryBind.getID());
