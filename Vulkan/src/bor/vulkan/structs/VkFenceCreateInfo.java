 ...
 */
 public class VkFenceCreateInfo extends VkStruct {
    ...
    */  
	 ...
	 */
	 public VkFenceCreateInfo(long address){ 
		 super(address); 
	 }
	 ...
	 */ 
	 public VkFenceCreateInfo sType(VkStructureType sType){
		 this.sType = sType;
	 ...
	 * @return this VkStruct instance.
	 */ 
	 public VkFenceCreateInfo pNext(VkObject pNext){
		 this.pNext = pNext;
	 ...
	 * @return this VkStruct instance.
	 */ 
	 public VkFenceCreateInfo flags(int flags){
		 this.flags = flags;
    ...
    */
    ...
    public String toString() {
         ...
         builder.append("VkFenceCreateInfo [ ")
