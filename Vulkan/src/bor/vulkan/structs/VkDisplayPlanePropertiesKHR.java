 ...
 */
 public class VkDisplayPlanePropertiesKHR extends VkStruct {
    ...
    */  
	 ...
	 */
	 public static VkArray<VkDisplayPlanePropertiesKHR> createVkArray(int size){ 
		 VkDisplayPlanePropertiesKHR[] array = new VkDisplayPlanePropertiesKHR[size]; 
		 VkArrayStruct<VkDisplayPlanePropertiesKHR> vkArray = new VkArrayStruct<VkDisplayPlanePropertiesKHR> (array, TAG_ID);
		 return vkArray; 
	 } 
