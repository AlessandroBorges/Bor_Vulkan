 ...
 */
 public class VkDescriptorImageInfo extends VkStruct {
    ...
    */  
	 ...
	 */
	 public static VkArray<VkDescriptorImageInfo> createVkArray(int size){ 
		 VkDescriptorImageInfo[] array = new VkDescriptorImageInfo[size]; 
		 VkArrayStruct<VkDescriptorImageInfo> vkArray = new VkArrayStruct<VkDescriptorImageInfo> (array, TAG_ID);
		 return vkArray; 
	 } 
