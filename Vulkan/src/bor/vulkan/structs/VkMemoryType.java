 ...
 */
 public class VkMemoryType extends VkStruct {
    ...
    */  
	 ...
	 */
	 public static VkArray<VkMemoryType> createVkArray(int size){ 
		 VkMemoryType[] array = new VkMemoryType[size]; 
		 VkArrayStruct<VkMemoryType> vkArray = new VkArrayStruct<VkMemoryType> (array, TAG_ID);
		 return vkArray; 
	 } 
