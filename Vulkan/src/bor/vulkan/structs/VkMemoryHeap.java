 ...
 */
 public class VkMemoryHeap extends VkStruct {
    ...
    */  
	 ...
	 */
	 public static VkArray<VkMemoryHeap> createVkArray(int size){ 
		 VkMemoryHeap[] array = new VkMemoryHeap[size]; 
		 VkArrayStruct<VkMemoryHeap> vkArray = new VkArrayStruct<VkMemoryHeap> (array, TAG_ID);
		 return vkArray; 
	 } 
